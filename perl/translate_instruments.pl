...
#   siaf_PRDOPSSOC-034 values
#
    my $x0_nc  =   -0.327628886710222/60.0;
    my $y0_nc  = -492.965888870059/60.0;
# NRS_VIGNETTED_MSA
...
sub translate_nircam_to_mirim{
    ...
    my($angle) = $pa * $qq;
#
#   V2, V3 (arc sec) -> (arc min)
#   siaf_PRDOPSSOC-034 values
#
    my $x0_nc     =   -0.327628886710222/60.0;
    my $y0_nc     = -492.965888870059/60.0;
#
    my $x0_mirim  =  -453.5591160661637/60.0;
    my $y0_mirim  =  -373.8144468729252/60.0;
#
    my $cosa   =  cos($angle) ;
    my $sina   =  sin($angle);
#
