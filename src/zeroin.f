...
c
c
c     This routine is available from netlib, and is based on 
c     R. Brent algol 60,  in "Algorithms for Minimization without 
c     Derivatives", 1973, Prentice-Hall. 
c     The version used here is one that was modified for use under Starlink.
c
c     2015-03-22
c
