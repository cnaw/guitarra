...
c     
         ...
         status =  0
         if(verbose.ge.2) print *,'tute_keywords: ftpkyj ', 
     &        key,' ',cont_id
c     
c-------------------------------------------------------------------
c     
...
C     
         ...
         status =  0
         if(verbose.ge.2) print *,'tute_keywords: ', key,' ',mu_epoch
c     
c     "degrees"
c     
...
c     
         ...
         status =  0
c     
         call ftpkys(iunit,'CTYPE3','none',comment,status)
         if (status .gt. 0) then
            call printerror(status)
            print *, 'CTYPE3'
         end if
...
c     
         ...
         call ftpkys(iunit,'CUNIT3',trim(cunit3),comment,status)
         if (status .gt. 0) then
            call printerror(status)
            print *, 'CUNIT3'
         end if
